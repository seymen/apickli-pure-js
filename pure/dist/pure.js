...
(function($PS) {
  ...
  var get$prime$prime = function (url) {
      return Control_Promise.fromAff(Affjax.get(Affjax_ResponseFormat.json)(url));
  };
  var get = Effect_Uncurried.mkEffectFn1(get$prime$prime);
  var eitherP = Data_Either.either;
  exports["get"] = get;
  exports["eitherP"] = eitherP;
})(PS);
