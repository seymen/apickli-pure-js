...
(function($PS) {
  ...
  var get$prime = function (url) {
      return Control_Promise.fromAff(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)(url))(function (result) {
          ...
          throw new Error("Failed pattern match at Pure (line 24, column 3 - line 26, column 26): " + [ result.constructor.name ]);
      }));
  };
