...
(function($PS) {
  ...
  var get$prime = function (reqCtx) {
      return Control_Promise.fromAff(Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request(Data_Tuple.snd(reqCtx)))(function (result) {
          if (result instanceof Data_Either.Left) {
              return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error(Affjax.printError(result.value0)));
          };
          if (result instanceof Data_Either.Right) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(result.value0);
          };
          throw new Error("Failed pattern match at Pure (line 36, column 3 - line 38, column 26): " + [ result.constructor.name ]);
      }));
  };
  var get = Effect_Uncurried.mkEffectFn1(get$prime);
  var defaultContext = {
      templateChar: "`"
  };
  var requestContext = function (ctx) {
      return function (req) {
          var mergedReq = Record.merge()()(req)(Affjax.defaultRequest);
          var mergedCtx = Record.merge()()(ctx)(defaultContext);
          return new Data_Tuple.Tuple(mergedCtx, mergedReq);
      };
  };
  exports["get"] = get;
  exports["requestContext"] = requestContext;
})(PS);
module.exports = PS["Pure"];
